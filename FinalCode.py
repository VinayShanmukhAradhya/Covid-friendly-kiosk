...
def Pdoba():
    global orderlist
     # Start the video cam and display main menue
    print('###############################')
    print("Welcome to Pdoga, kindly place your order")
    print('###############################')
    print("S.No \t Dish \t Price")
    print("1: \t Mexican Bowl \t 10.00$")
    print("2: \t Burrito \t 8.00$")
    print("3: \t Tacos \t 7.50$")
    print("Thumbs up: \t Exit to main menu \n")
    label = 'no'
...
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Mexican Bowl')
        elif label == 'two':
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Burrito')
        elif label =='three':
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Taco')
        elif label =='confirm':
...
def Organ():
    global orderlist
     # Start the video cam and display main menue
    print('###############################')
    print("Welcome to Organ, kindly place your order")
    print('###############################')
    print("S.No \t Dish \t Price")
    print("1: \t Fried Rice \t 6.00$")
    print("2: \t Tofu with Fried Rice \t 8.00$")
    print("3: \t Meat with Fried Rice \t 10.00$")
    print("Thumbs up: \t Exit to main menu \n")
    label = 'no'
    cap = cv2.VideoCapture(0)
    width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
...
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Fried Rice')
        elif label == 'two':
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Tofu with Fried Rice')
        elif label =='three':
#             cap.release()
#             cv2.destroyAllWindows()
            orderlist.append('Meat with Fried Rice')
        elif label =='confirm':
            orderlist = list(set(orderlist))
            cap.release()
            cv2.destroyAllWindows()
...
def MambaJuice():
    global orderlist
     # Start the video cam and display main menue
    print('###############################')
    print("Welcome to Mamba Juice, kindly place your order")
    print('###############################')
    print("S.No \t Dish \t Price")
    print("1: \t juice \t 7.00$")
    print("2: \t coffee\t 3.00$")
...
def mainMenu():
    ...
    print('###############################')
    print("Which restraunt would you like to order from?")
    print("1: \t Pdoba")
    print("2: \t Organ")
    print("3: \t Mamba Juice")
...
#             break
    ...
    priceDict = {'Coffee':3.00,
                ...
                'Taco':7.50,
                'Fried Rice':6.00,
                'Tofu with Fried Rice':8.00,
                'Meat with Fried Rice':10.00}
    print('Your order is complete')
    total = sum([priceDict[x] for x in orderlist])
    print('your Bill is given below')
    df = pd.DataFrame({'S.no':list(range(len(orderlist))),
                        'Item':orderlist,
                        'Price':[priceDict[i] for i in orderlist]})
    # print('S.No \t \t Item \t \t Price')
    # for i in range(len(orderlist)):
    #     print('{} \t \t {} \t \t {}'.format(i+1,orderlist[i],priceDict[orderlist[i]]))
    print(df)
...
if __name__ == "__main__":
    ...
    print('###############################')
    print('\n ')
    print("Welcome to the Gesture Kiosk")
    print('\n')
    print('###############################')
    print('\n ')
    print("Please choose one of the options using the gestures provided")
    print("Use the cancel gesture to restart \n")
    orderlist = []
    mainMenu()
